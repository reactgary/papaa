...
#define CounterControlledInput_PCIE_ALIGNMENT (16)
...
int CounterControlledInput_has_errors(void);
const char* CounterControlledInput_get_errors(void);
void CounterControlledInput_clear_errors(void);
/* Free statically allocated maxfile data */
void CounterControlledInput_free(void);
/* returns: -1 = error running command; 0 = no error reported */
int CounterControlledInput_simulator_start(void);
/* returns: -1 = error running command; 0 = no error reported */
int CounterControlledInput_simulator_stop(void);
